...
if (n.c === 0) {
  ...
  [
    ...
    ['colores','Verde Salvia','El verde apagado y herbal replace el verde bosque. Muy fuerte en prendas de abrigo y capas.',7,'fuerte'],
    ...
    ['siluetas','Crop Extremo','El crop radical (encima del ombligo) pierde fuerza en outerwear. Se mantiene en casual pero cede terreno.',3,'decayendo'],
    ...
    ['estampados','Lisos Texturizados','El "estampado" más vendido: liso pero con textura visible (jacquard, relieve, tejido). Sofisticación sin ruido.',7,'fuerte'],
    ['estampados','Rayas Verticales Bold','Rayas anchas en dos colores contrastantes. Efecto vertical estilizador. Fuerte en blazers y pantalones.',6,'emergente'],
    ['estampados','Tie-Dye Refinado','El tie-dye artesanal y de paleta suave sube lento. Diferente al tie-dye saturado de 2020.',4,'emergente'],
    ['estampados','Tropical Vibrante','Palmeras, flores tropicales en colores saturados. Saturado y en descenso rápido.',2,'decayendo'],

    // ESTILOS
    ['estilos','Quiet Luxury','Menos logos, más calidad. Prendas que gritan sofisticación sin etiqueta visible. El lujo silencioso domina.',10,'fuerte'],
    ['estilos','Coastal Grandmother','Ropa de resort relajada pero elegante. Linos, rayas, neutros. De vacaciones pero refinada.',8,'fuerte'],
    ['estilos','Corporate Chic','La oficina vuelve a ser aspiracional. Blazers, pantalones sastre, gabardinas. Power dressing moderno.',8,'fuerte'],
    ['estilos','Dopamine Dressing','Color como terapia. Prendas vibrantes para el bienestar emocional. Más sostenido de lo esperado.',6,'fuerte'],
    ['estilos','Ballet Core','Inspiración en la bailarina: faldas midi, wrap tops, colores pastel, lazos. Muy femenino y elegante.',7,'emergente'],
    ['estilos','Tomboy Luxe','Prendas masculinas en telas lujosas y cortes femeninos. El poder del contraste.',6,'emergente'],
    ['estilos','Y2K Revival','El regreso de los 2000: colores metálicos, low rise, mini. Lleva tiempo pero pierde fuerza en outerwear.',3,'decayendo'],
  ].forEach(d => iT.run(...d));
  ...
  [
    ...
    [2023,'SS','telas','Crochet y Macramé','Prendas artesanales de crochet para el verano. Muy fotografiadas, menos vendidas.','decayendo'],
    ...
    [2023,'FW','telas','Terciopelo Aplastado','El terciopelo oscuro y aplastado fue el tejido del invierno 2023. Vestidos, blazers, faldas.','furor'],
    [2023,'FW','estilos','Quiet Luxury','Emerges con fuerza en FW23 impulsado por series como Succession. El logo desaparece.','emergiendo'],
    ...
    [2024,'SS','siluetas','Mini + Botas Altas','La combinación más fotografiada del verano 2024. Corto arriba, largo abajo.','furor'],
    [2024,'SS','estampados','Flores Abstractas','No el floral clásico: flores grandes, gráficas, en paletas inesperadas. Nuevo romanticismo.','furor'],
    [2024,'SS','estilos','Quiet Luxury','Se consolida como el estilo aspiracional dominante. Las marcas de logo pierden terreno.','furor'],
    [2024,'FW','colores','Rojo Cereza','Entró fuerte en FW24: profundo, maduro, opuesto al rojo vibrante de temporadas pasadas.','furor'],
    [2024,'FW','siluetas','Oversized Estructurado','El oversized madura: deja de ser flojo y se vuelve arquitectónico. Hombros, largo y construcción.','furor'],
    ...
    // 2025
    [2025,'SS','colores','Verde Salvia + Azul Marino','Los colores frescos de SS25: salvia apagada y marino profundo reemplazan los pasteles obvios.','furor'],
    ...
    [2025,'SS','estilos','Ballet Core','Se consolida: ya no es tendencia emergente sino estilo establecido. Las marcas masivas lo copian.','furor'],
    [2025,'FW','colores','Negro Total + Rojo Cereza','Bicolor potente para FW25. Negro como base, rojo cereza como statement.','furor'],
    ...
    [2025,'FW','telas','Lana Premium + Cuero Vegano','Las dos pieles del invierno 2025: lana de calidad y cuero vegano de nueva generación.','furor'],
    [2025,'FW','estilos','Tomboy Luxe','Blazers masculinos en telas lujosas, pantalón de pinza ancho. Poder y feminidad simultáneos.','emergiendo'],
  ].forEach(d => iC.run(...d));

  const iP = db.prepare('INSERT INTO proyecciones (anio,escenario,categoria,proyeccion,descripcion) VALUES (?,?,?,?,?)');
  [
    // 2026 - CONSERVADOR
    [2026,'conservador','colores','Neutros con un acento','Paleta dominante de beige, crema y gris perla con un color de acento por temporada (borgoña o azul prusia). El cliente busca seguridad en la inversión.'],
    [2026,'conservador','siluetas','Oversized controlado + Línea A','Las dos siluetas ya establecidas se mantienen sin grandes cambios. Evolución más que revolución.'],
    ...
    // 2026 - PROBABLE
    [2026,'probable','colores','Rojo + Chocolate + Crema','Triada terrosa-cálida. El chocolate emerge como nuevo neutro, el rojo se modera, la crema conecta todo.'],
    ...
    [2026,'probable','telas','Cuero Vegano + Denim Premium','Materiales con presencia que van más allá de la moda hacia el lifes tyle.'],
    ...
    [2026,'tendencia_fuerte','colores','Morado Uva + Plata Mercurio','Combinación inesperada pero con precedente en las pasarelas de vanguardia. Alto riesgo, alto impacto.'],
    [2026,'tendencia_fuerte','siluetas','Asimetría Calculada','Dobladillos irregulares, un hombro descubierto, cierres laterales. La imperfección como diseño.'],
    [2026,'tendencia_fuerte','telas','Materiales Técnicos Couture','Telas de alto rendimiento (impermeables, anti-arrugas) en cortes y acabados de lujo.'],
    [2026,'tendencia_fuerte','estampados','Fotografía Digital + Pixel Art','La imagen digital se transfiere al tejido. Fotorrealismo y arte pixelado en prendas de autor.'],

    // 2027 - CONSERVADOR
    [2027,'conservador','colores','Regreso al Blanco Óptico','El blanco puro como declaración de intenciones. Opuesto al beige y crema. Minimalismo extremo.'],
    [2027,'conservador','siluetas','Tailoring Clásico','El traje sastre tradicional resurge sin modificaciones. La elegancia de siempre.'],
    [2027,'conservador','telas','Seda Natural y Lino Premium','Materiales nobles y naturales como respuesta al fast fashion y los sintéticos.'],
    [2027,'conservador','estampados','Sin Estampado','El liso absoluto domina. El color de la prenda es suficiente declaración.'],
    // 2027 - PROBABLE
    [2027,'probable','colores','Paleta Bosque: Verde Musgo + Marrón Turba','Tonos muy orgánicos y cargados de tierra. Conexión con naturaleza en su expresión más sofisticada.'],
    ...
    [2027,'probable','telas','Regenerativas y Trazables','La tela cuenta su historia: origen, proceso, impacto. El consumidor exige transparencia.'],
    [2027,'probable','estampados','Tejido Artesanal Visible','El tejido manual (telar, bordado regional) como estampado político y estético.'],
    // 2027 - TENDENCIA FUERTE
    [2027,'tendencia_fuerte','colores','Metálicos Mate: Oro Viejo + Cobre','Metales sin brillo. La sofisticación del metal opaco versus el exceso del glitter.'],
    [2027,'tendencia_fuerte','siluetas','Híbrida: Prenda Multifunción','Una pieza que es tres: chaqueta + chaleco + capucha. La versatilidad como lujo.'],
    [2027,'tendencia_fuerte','telas','Biomateriales: Micelio y Algas','Las telas del futuro llegan al mainstream. Sostenibles, únicas, premium.'],
    [2027,'tendencia_fuerte','estampados','Generativo por IA','Estampados creados por algoritmos, únicos por prenda. La exclusividad matemática.'],
  ].forEach(d => iP.run(...d));
}
...
module.exports = { getTendencias, getTendenciasCat, getCronologia, getCronologiaFiltro, getProyecciones, getProyFiltro };
